...
const fetchProjectsData = cache(
  async (): Promise<Partial<IndiaProjectsData>> => {
    try {
      const projectsData = await getIndiaProjectsData();
      return projectsData || {};
    } catch (error) {
...
const page = async () => {
  ...
  return (
    <div className="bg-white dark:bg-[#353535] flex flex-col md:overflow-hidden">
      ...
      />
      <div className="flex-1 flex flex-col py-[60px] p-[50px] max-md:p-[40px_20px_60px_20px] gap-[40px] max-w-[1440px] mx-auto">
