...
import OriginsProject from "../components/originsProject";
...
export const generateMetadata = async (): Promise<Metadata> => {
  try {
    ...
    return {
      ...
      description,
      alternates: {
        canonical: process.env.NEXT_PUBLIC_BASE_DOMAIN + "/projects/origins",
      },
      openGraph: {
        title: ogTitle,
...
const page = async () => {
  ...
  return (
    <div className="bg-white dark:bg-[#353535] flex flex-col md:overflow-hidden">
      ...
      />
      <OriginsProject projectsData={projectsData?.data} />
