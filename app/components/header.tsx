...
const Header = ({ innerPage, bgImage }: Props) => {
  return (
    <React.Fragment>
      {!innerPage ? (
        <div className="bg-white dark:bg-[#353535] sticky top-0 z-50 w-full p-[50px_50px_0px_50px] max-md:p-[15px_20px] max-md:bg-white/10 max-md:dark:bg-[#353535]/10 max-md:backdrop-blur-[3px] max-md:border-b max-md:border-white/20 max-md:dark:border-[#353535]/20">
          <div className="">
